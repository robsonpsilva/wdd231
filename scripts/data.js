...
// Função para filtrar os botões com base no "subject"
export function filter(subject) {
    ...
    filteredCourses.forEach(course => {
        ...
        button.onclick = () => alert(`Você selecionou: ${course.title}`);
        dynamicSection.appendChild(button);
    });
}

// Chamar automaticamente "ALL" no carregamento da página
filter('ALL');